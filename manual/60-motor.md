...
El submódulo `motor/` implementa el sustrato base C1 (base de datos de grafos Neo4j) y C2 (el esquema congelado del Personal Knowledge Graph, PKG) dentro de Khora. Este motor es accesible estrictamente mediante la API del kernel y no se debe importar directamente desde el exterior.
