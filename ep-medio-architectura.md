...
1. El usuario navega a la sección principal **Seguridad** (`/sistema/seguridad`) o mediante la redirección HTTP 308 desde `/sistema/entorno-persistente` hacia `/sistema/seguridad?tab=entorno-persistente`.
