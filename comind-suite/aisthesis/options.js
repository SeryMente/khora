...
async function render(){
  ...
  ch += "<tr><td>Token</td><td class='mut'>ntn_6669...xdoq (hardcodeado)</td></tr>";
...
var _hk=null;
async function loadHotkeys(){ try{ var r=await fetch(chrome.runtime.getURL("hotkeys.json")); _hk=await r.json(); }catch(e){ _hk=null; } renderHotkeys(); }
