    ...
    <main className="min-h-screen bg-cora-bg p-4 md:p-8 font-sans pb-32">
      <div className="max-w-4xl mx-auto space-y-8 mt-12">
        <header className="mb-10">
          ...
          <p className="text-cora-silver mt-2">Agentes inteligentes, análisis y refracción de datos.</p>
        </header>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          <div className="bg-cora-surface border border-cora-silver/10 rounded-xl p-5 hover:border-cora-silver/20 transition-all flex items-start gap-4">
            ...
            <div>
              <h3 className="font-semibold text-cora-text">Modelos Generativos (Próximamente)</h3>
              <p className="text-xs text-cora-silver mt-1">Configuración y estado de motores de inferencia.</p>
            </div>
          </div>
          <div className="bg-cora-surface border border-cora-silver/10 rounded-xl p-5 hover:border-cora-silver/20 transition-all flex items-start gap-4">
            <div className="p-3 bg-black/5 dark:bg-white/[0.03] rounded-lg">
            ...
            <div>
              <h3 className="font-semibold text-cora-text">Telemetría Avanzada (Próximamente)</h3>
              <p className="text-xs text-cora-silver mt-1">Análisis de patrones en la memoria continua.</p>
            </div>
          </div>
        </div>
      </div>
