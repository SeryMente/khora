...
export default function ConsultaPage() {
	...
	const fuentes = resultado && Array.isArray(resultado.evidencia) ? resultado.evidencia : [];
	...
	return (
		<div className="max-w-4xl mx-auto p-6">
			...
			{error && (
				<div className="p-4 mb-6 bg-gray-50 dark:bg-gray-900/40 border border-gray-200 dark:border-gray-700 rounded-lg text-gray-700 dark:text-gray-300 flex flex-col">
			...
			{resultado && (
				<div className="bg-white dark:bg-gray-800 rounded-xl shadow-md border border-gray-200 dark:border-gray-700 overflow-hidden">
					{typeof resultado.suficiencia !== "boolean" ? (
						<div className="p-6 text-center text-gray-500 dark:text-gray-400">Contrato incompleto</div>
					) : (
						<>
							...
							{resultado.respuesta !== null && resultado.respuesta !== undefined && (
								<div className="p-6">
