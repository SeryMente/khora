    ...
    <main className="min-h-screen bg-cora-bg p-4 md:p-8 font-sans pb-32">
      <div className="max-w-4xl mx-auto space-y-8 mt-12">
        <header className="mb-10">
          ...
          <p className="text-cora-silver mt-2">Conectores, automatizaciones y flujos de datos externos.</p>
        </header>

        <div className="space-y-6">
          <div className="bg-cora-surface border border-cora-silver/10 rounded-xl p-6 hover:border-cora-silver/20 transition-all">
            <div className="flex items-start gap-4">
              ...
              <div className="flex-1">
                <div className="flex items-center justify-between">
                  <h3 className="text-lg font-semibold text-cora-text">Extensión Harmonia</h3>
                  <span className="px-2 py-1 bg-black/5 dark:bg-white/[0.05] text-xs font-mono rounded text-cora-silver">
                    v{version}
                  </span>
                </div>
                <p className="text-sm text-cora-silver mt-2 mb-4">
                ...
                <div className="space-y-4">
                  ...
                  <div className="text-sm text-cora-silver bg-black/5 dark:bg-white/[0.02] p-4 rounded-lg">
                    <p className="font-semibold text-cora-text mb-1">Pasos de instalación:</p>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mt-8">
          <div className="bg-cora-surface border border-cora-silver/10 rounded-xl p-5 hover:border-cora-silver/20 transition-all flex items-start gap-4 opacity-50">
            <div className="p-3 bg-black/5 dark:bg-white/[0.03] rounded-lg">
              <Workflow className="w-5 h-5 text-indigo-400" />
            </div>
            <div>
              <h3 className="font-semibold text-cora-text">Pipelines (Próximamente)</h3>
              <p className="text-xs text-cora-silver mt-1">Gestión de orquestación de datos.</p>
            </div>
          </div>
          <div className="bg-cora-surface border border-cora-silver/10 rounded-xl p-5 hover:border-cora-silver/20 transition-all flex items-start gap-4 opacity-50">
            <div className="p-3 bg-black/5 dark:bg-white/[0.03] rounded-lg">
            ...
            <div>
              <h3 className="font-semibold text-cora-text">Webhooks (Próximamente)</h3>
              <p className="text-xs text-cora-silver mt-1">Puntos de entrada para servicios de terceros.</p>
            </div>
          </div>
        </div>
