(function(){
  ...
  var _meterOn = true, _pcs = [], _boostGain = null;
  ...
  window.addEventListener("message", function(ev){
    ...
    // v1.1.0: el booster (mundo ISOLATED) difunde su gain para correlacionar con la calidad.
    else if(d && d.__globo === "boostState" && typeof d.gain === "number"){ _boostGain = d.gain; }
  });
  try{ window.postMessage({ __globo:"meterReq" }, "*"); }catch(e){}
  try{ window.postMessage({ __globo:"boostStateReq" }, "*"); }catch(e){}
  var _lastSamp = {};
