...
require("EP_VERSION = '1.0.1'" in gate,'Versión EP incorrecta')
require("SCRIPT_VERSION = '7.5.1'" in gate,'Versión host incorrecta')
...
print('EP v1.0.1 static validation: OK')
